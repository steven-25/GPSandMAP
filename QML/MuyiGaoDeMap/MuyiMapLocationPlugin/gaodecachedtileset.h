#ifndef GAODECACHEDTILESET_H
#define GAODECACHEDTILESET_H
...
#include <QList>
class GaoDeTile;
class GaoDeCachedTileSet : public QObject
{
    Q_OBJECT
public:
    explicit GaoDeCachedTileSet(const QString& name, const QString& description);
    ~GaoDeCachedTileSet ();
...
private slots:
    void _tileListFetched               (QList<GaoDeTile*> tiles);
...
private:
    ...
    quint32     _errorCount;
    //-- Tile download
    QList<GaoDeTile *> _tilesToDownload;
    bool        _noMoreTiles;
    bool        _batchRequested;
    QImage      _thumbNail;
};

#endif // GAODECACHEDTILESET_H
