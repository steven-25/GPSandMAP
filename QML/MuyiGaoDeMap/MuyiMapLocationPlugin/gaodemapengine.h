#ifndef GAODEMAPENGINE_H
#define GAODEMAPENGINE_H
...
public:
    ...
    GaoDeTileSet& operator += (GaoDeTileSet& other)
    {
        tileX0      += other.tileX0;
        tileX1      += other.tileX1;
        tileY0      += other.tileY0;
...
class GaoDeMapEngine : public QObject
{
    Q_OBJECT
public:
    GaoDeMapEngine(QObject *parent = 0);
    ~GaoDeMapEngine();

    void                        init                ();
    void                        addTask             (GaoDeMapTask *task);
    ...
    GaoDeFetchTileTask*           createFetchTileTask (UrlFactory::MapType type, int x, int y, int z);
    ...
    //-- Tile Math
    static GaoDeTileSet           getTileCount        (int zoom, double topleftLon, double topleftLat, double bottomRightLon, double bottomRightLat, UrlFactory::MapType mapType);
...
extern GaoDeMapEngine*    getGaoDeMapEngine();
extern void             destroyMapEngine();
#endif // GAODEMAPENGINE_H
